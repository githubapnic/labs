...
- Run the setup script.
    ...
    The script creates the following lab topology [https://files.openli.nz/tutorial/chapter006.pdf%23page=11](https://files.openli.nz/tutorial/chapter006.pdf%23page=11)
