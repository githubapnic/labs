...
- Run tracepktdump as the HI2 handover. HI2 is for receiving IRI records from the mediator
    ...
    ```
    tracepktdump etsilive:@lab.Variable(AGENTIP):41002 | less
	```
...
- Run tracepktdump as the HI3 handover. HI3 is for receiving CC records from the mediator
    ...
    ```
    tracepktdump etsilive:@lab.Variable(AGENTIP):41003 | less
	```
...
- Add the details about the **Test Agency** by using curl to POST the agency JSON object.
	...
	```
	curl -X POST -H "Content-Type: application/json" -d '{ "agencyid": "testagency", "hi2address": "@lab.Variable(AGENTIP)", "hi3address": "@lab.Variable(AGENTIP)", "hi2port": "41002", "hi3port": "41003",  "keepalivefreq": 60, "keepalivewait": 30 }' http://172.18.0.2:8080/agency
	```
	...
	-d '{ 
	"agencyid": "testagency", 
	"hi2address": "@lab.Variable(AGENTIP)", 
	"hi3address": "@lab.Variable(AGENTIP)", 
	"hi2port": "41002", 
	"hi3port": "41003", 
	"keepalivefreq": 60, 
	"keepalivewait": 30 
